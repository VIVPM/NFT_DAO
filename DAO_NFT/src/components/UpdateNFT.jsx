...
import { updateNFT } from '../Blockchain.Services1'
...
const UpdateNFT = () => {
  ...
  return (
    ...
    >
      <div className="bg-yellow shadow-xl shadow-[#e32970] rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <form className="flex flex-col">
          ...
          <div className="flex flex-row justify-between items-center bg-yellow-800 rounded-xl mt-5">
            <input
