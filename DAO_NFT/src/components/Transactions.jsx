...
import { useGlobalState, truncate } from '../store1'
      ...
      <div className="w-4/5 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-4 lg:gap-2 py-2.5">
          {collection.map((tx) => (
            <div
              key={tx.id}
              className="flex justify-between items-center border border-pink-500 text-gray-400 w-full shadow-xl rounded-md overflow-hidden bg-blue-800 my-2 p-3"
            >
